...
export class DashboardService {
  getSalesSummary = async (filters: DateRangeFilter) => {
  ...
  getDailySalesChart = async (filters: DateRangeFilter) => {
    const { startDate, endDate } = filters;
  ...
  getTopProducts = async (filters: DateRangeFilter & { limit?: number }) => {
  ...
  getPurchaseSummary = async (filters: DateRangeFilter) => {
    const { startDate, endDate } = filters;
